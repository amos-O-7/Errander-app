...
import { Search, MapPin, Truck, Sparkles, ShoppingBag, Hammer, ArrowRight, Package, Clock, CheckCircle, List, ArrowUpRight, Bell, Star } from "lucide-react";
      ...
      <div className="pb-8">
        ...
        <div className="px-6 mb-8">
           <div className="bg-card p-4 rounded-2xl shadow-sm border border-border grid grid-cols-3 gap-4">
             ...
             <div className="text-center border-l border-border">
               ...
               <p className="text-[10px] uppercase font-bold text-muted-foreground mt-1">In Progress</p>
             </div>
             <div className="text-center border-l border-border">
        ...
        <div className="px-6 mb-8">
          ...
          <div className="grid grid-cols-4 gap-4">
            <CategoryItem icon={Truck} label="Delivery" color="bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400" />
            <CategoryItem icon={Sparkles} label="Cleaning" color="bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400" />
            <CategoryItem icon={ShoppingBag} label="Shopping" color="bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400" />
            <CategoryItem icon={Hammer} label="Repair" color="bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400" />
            <CategoryItem icon={Package} label="Moving" color="bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400" />
            <CategoryItem icon={Clock} label="Wait in Line" color="bg-teal-100 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400" />
          </div>
        </div>
        ...
        <div className="px-6 mb-8">
          <h2 className="text-lg font-bold text-foreground mb-4">Active Errands</h2>
          ...
          <div className="bg-card rounded-2xl p-4 shadow-sm border border-border">
            <div className="flex justify-between items-start mb-3">
              <div className="flex gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">Grocery Run</h3>
                  <p className="text-xs text-muted-foreground">Nakumatt Junction</p>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center text-sm">
              <span className="text-muted-foreground">Runner: <span className="text-foreground font-medium">David M.</span></span>
