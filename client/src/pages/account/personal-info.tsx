...
export default function PersonalInfo() {
  ...
  const [formData, setFormData] = useState({
    fullName: user.name || (role === 'customer' ? "Alex Kemboi" : "Errander Prime"),
    email: user.email || (role === 'customer' ? "alex.k@example.com" : "runner@example.com"),
    phone: user.mobileNo || (role === 'customer' ? "+254 712 345 678" : "+254 799 888 777"),
