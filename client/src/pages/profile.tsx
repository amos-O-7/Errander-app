    ...
    <MobileLayout userType={user.role}>
      <div className="pb-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex gap-4 w-full justify-center">
              <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-xl text-center">
                <p className="text-xs text-primary-foreground/70 uppercase font-bold">Role</p>
        ...
        <div className="px-6 space-y-6">
          ...
          <Button
            variant="outline"
            className="w-full h-12 rounded-xl text-red-500 hover:text-red-600 hover:bg-red-50 border-red-100 dark:border-red-900/30 dark:bg-red-900/10"
            onClick={logout}
          >
