...
export default function Auth() {
  ...
  // Extract role from query string (simple parse)
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      if (defaultRole === "errander") {
        setLocation("/errander/home");
      } else {
            ...
            <form onSubmit={handleLogin} className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="fname" placeholder="John" className="h-12 rounded-xl bg-gray-50" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lname">Last Name</Label>
                  <Input id="lname" placeholder="Doe" className="h-12 rounded-xl bg-gray-50" />
                </div>
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="reg-phone">Phone Number (M-Pesa)</Label>
                <Input id="reg-phone" placeholder="0712 345 678" className="h-12 rounded-xl bg-gray-50" />
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="reg-pass">Create Password</Label>
                <Input id="reg-pass" type="password" className="h-12 rounded-xl bg-gray-50" />
              </div>
